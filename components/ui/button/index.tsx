...
const buttonStyle = tva({
  base: "group/button rounded-[4px] bg-primary-500 flex-row items-center justify-center data-[focus-visible=true]:web:outline-none data-[focus-visible=true]:web:ring-2 data-[disabled=true]:opacity-40 gap-2",
  variants: {
    action: {
      primary:
...
const buttonTextStyle = tva({
  base: "text-typography-0 font-jakarta-bold web:select-none",
  parentVariants: {
    action: {
      primary:
